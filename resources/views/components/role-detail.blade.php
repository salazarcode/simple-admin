...
<div class="flex-1 bg-white p-6 overflow-y-auto">
    ...
    <div class="border-b border-gray-200 pb-6 mb-6">
        <div class="flex items-center space-x-4">
            ...
            <div>
                ...
                <p class="text-gray-600">{{ $role->permissions->count() }} permisos asignados</p>
                <p class="text-sm text-gray-500">
                    Creado el {{ $role->created_at->format('d/m/Y') }}
                </p>
            </div>
    ...
    <div class="mb-8">
        ...
        <div class="bg-gray-50 rounded-lg p-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-500">Nombre del Rol</label>
    ...
    <div class="mb-8">
        <h2 class="text-lg font-semibold text-gray-900 mb-4">
            Usuarios con este Rol ({{ $usersWithRole->count() }})
        </h2>
        ...
        @else
            <div class="bg-gray-50 border border-gray-200 rounded-lg p-8 text-center">
                ...
                <p class="text-gray-600">Ningún usuario tiene este rol asignado</p>
            </div>
        @endif
    </div>
                    ...
                    @foreach($role->permissions as $permission)
                        <div class="flex items-center space-x-3 bg-white rounded-lg p-3">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <p class="text-xs text-gray-500">Creado {{ $permission->created_at->format('d/m/Y') }}</p>
                            </div>
                        </div>
                    @endforeach
                </div>
...
<div class="flex-1 bg-gray-50 flex items-center justify-center">
    <div class="text-center">
        ...
        <h3 class="text-lg font-medium text-gray-900 mb-2">Selecciona un rol</h3>
        <p class="text-gray-600">Selecciona un rol de la lista para ver sus detalles</p>
    </div>
</div>
@endif