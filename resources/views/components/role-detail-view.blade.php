        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="ml-auto flex space-x-3">
                <button 
                    ...
                    class="bg-[#F56E0F] text-white px-4 py-2 rounded-lg hover:bg-orange-600 transition-colors duration-150"
                >
                    Editar Rol
                </button>
                <button 
    ...
    <div class="mb-8">
        ...
        @else
            <div class="bg-[#262626] border border-gray-600 rounded-lg p-8 text-center">
                ...
                <button 
                    wire:click="editRole({{ $item->id }})" 
                    class="mt-2 text-[#F56E0F] hover:text-orange-400 text-sm"
                >
                    Asignar permisos
                </button>
            </div>
            ...
            <div class="bg-[#262626] border border-gray-600 rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-[#F56E0F]">{{ $item->permissions->count() }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-[#262626] border border-gray-600 rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-[#F56E0F]">{{ $item->users->count() ?? 0 }}</p>
                    </div>
                </div>
            </div>
